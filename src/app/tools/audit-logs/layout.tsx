    ...
    return (
      <div className="min-h-screen bg-muted flex items-center justify-center">
        <div className="text-center">
          ...
          <h1 className="text-2xl font-bold text-foreground mb-4">Staff Access Required</h1>
          <p className="text-muted-foreground mb-2">You need admin or moderator privileges to access audit logs.</p>
