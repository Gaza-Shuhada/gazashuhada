...
export default function AdminLayout({ children }: AdminLayoutProps) {
    ...
    return (
      <div className="min-h-screen bg-muted flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground mb-6">You must be signed in to access admin features.</p>
          <Link
            href="/sign-in"
    ...
    return (
      <div className="min-h-screen bg-muted flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground mb-2">You need admin privileges to access this area.</p>
  ...
  return (
    <div className="min-h-screen bg-muted">
      {/* Admin Header */}
      <div className="bg-background shadow-sm border-b border">
